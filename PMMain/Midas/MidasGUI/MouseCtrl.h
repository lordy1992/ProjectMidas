...
public:
    ...
    */
     ...
     */
	void sendCommand(mouseCmds mouseCmd, int mouseRateIfMove = 0, int mouseRateIfMoveY_hack = 0);
...
private:
     ...
     */
	void setMouseInputVars(mouseCmds mouseCmd, int& mouseRateIfMove, int& mouseRateIfMoveY_hack);
